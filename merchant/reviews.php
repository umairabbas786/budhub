      ...
      <div class="layout-page">
        ...
        <div class="content-wrapper p-3">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="row mt-2">
              <div class="col-md-12">
                <h3 class="mb-0" style="color: #169256;">Customer Reviews</h3>
...
<div class="card mt-3">
  <div class="card-datatable text-nowrap">
    <table class="datatables-basic table table-bordered" id="orders">
      <thead>
        <tr>
          <th style="color: #169256;font-weight:700">Customer</th>
          <th style="color: #169256;font-weight:700">Review</th>
          <th style="color: #169256;font-weight:700">Rating</th>
          <th style="color: #169256;font-weight:700">Date Created</th>
        </tr>
      </thead>
      <tbody>
        <tr>
