                                    ...
                                    <table class="datatables-basic table table-bordered" id="orders">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="color: #169256;font-weight:700">Featured</th>
                                                <th style="color: #169256;font-weight:700">Popular</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center"><input class="form-check-input select-all" type="checkbox" id="selectAll" data-value="all" readonly></td>
                                                <td>Demo</td>
                                            </tr>
                                            <tr>
                                                <td>Demo</td>
